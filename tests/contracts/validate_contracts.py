...
EXPECTED = {
    ...
    "knowledge-ingestion-job.schema.json", "knowledge-ingestion-result.schema.json",
    ...
    "knowledge-evidence-v2.schema.json", "knowledge-claim-v2.schema.json",
...
def main() -> int:
    ...
    if asyncapi.get("asyncapi") != "3.0.0" or asyncapi.get("info", {}).get("version") != "1.10.0":
